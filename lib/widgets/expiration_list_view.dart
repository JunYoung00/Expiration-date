  ...
  static Widget buildAddDialog({
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          TextField(controller: nameCtrl, decoration: const InputDecoration(labelText: '음식 이름')),
          ...
          ElevatedButton(
            ...
            child: Text(pickedDate == null ? '유통기한 선택' :
      ...
      actions: [
        ...
        TextButton(
          onPressed: () {
            if (pickedDate != null && nameCtrl.text.trim().isNotEmpty) {
              final newItem = {
                'name': nameCtrl.text.trim(),
                'expirationDate': pickedDate!.toIso8601String(),
              };
              onAdd(newItem);
