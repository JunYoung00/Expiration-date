...
class NotificationService {
  ...
  static void testDummyExpirationAlert() {
    final dummyItems = [
      {'name': 'milk', 'expiration': DateTime.now().add(Duration(days: 7))},
      {'name': 'egg', 'expiration': DateTime.now().add(Duration(days: 10))},
      {'name': 'dooboo', 'expiration': DateTime.now().add(Duration(days: 2))},
    ];
